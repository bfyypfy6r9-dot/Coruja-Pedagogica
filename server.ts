...
// Valores provisórios adicionados para corrigir a Tela Branca no Render
// @ts-ignore
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://provisorio.supabase.co';
// @ts-ignore
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'chave-provisoria';
...
function Login({ onLogin, onCancel }: LoginProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-neutral-900/40 backdrop-blur-sm flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      {onCancel && (
        <button 
          onClick={onCancel}
          className="absolute top-6 right-6 p-2 text-neutral-400 hover:text-neutral-700 bg-white rounded-full shadow-sm border border-neutral-200 transition-colors"
          title="Voltar ao App"
        >
          <X className="w-6 h-6" />
        </button>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-sm border border-neutral-200 sm:rounded-xl sm:px-10">
          ...
          {error && (
            <div className="mb-4 bg-red-50 border-l-4 border-red-500 p-4 shrink-0 rounded-r-md">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-neutral-300 rounded-md py-2 border outline-none"
